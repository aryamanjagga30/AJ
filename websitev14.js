// WEBSITEV15 - Mobile Detection + Scene 2 Camera for Mobile
...
if (IS_MOBILE) {
  ...
  // Still load the 3D scene but with fixed camera
  initMobileScene();
} else {
...
// ===== DESKTOP SCENE (FULL INTERACTIVE) =====
function initDesktopScene() {
  ...
  console.log('🎬 V15 - Desktop mode with full navigation');
}

console.log('🎬 V15 - Mobile detection active');